...
Star.prototype.update = function () {
  this.draw(); //when bal hits bottom
  ...
  this.x += this.velocity.x; // when ball hits side screen

  if (this.y + this.radius + this.velocity.x > canvas.width || this.x - this.radius <= 0) {
...
function animate() {
  ...
  if (ticker % randomSpawn == 0) {
    ...
    randomSpawn = _utils__WEBPACK_IMPORTED_MODULE_0___default.a.randomIntFromRange(75, 200);
  }
}
